...
{
    public partial class printInventoryReportByCategory : Form
    {
        Timer t = new Timer();
        string user;
        ...
        public printInventoryReportByCategory()
        {
            InitializeComponent();
        }

        private void printInventoryReportByCategory_Load(object sender, EventArgs e)
        {
