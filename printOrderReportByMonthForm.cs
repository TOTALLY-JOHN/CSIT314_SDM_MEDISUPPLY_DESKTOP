...
{
    public partial class printOrderReportByMonthForm : Form
    {
        Timer t = new Timer();
        string user;
        ...
        public printOrderReportByMonthForm()
        {
            InitializeComponent();
        }

        private void printOrderReportByMonthForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "SELECT orderID, orders.clinicName, clinic.clinicAddress, itemType, orders.itemQuantity, orderDate, itemSellingPrice FROM orders JOIN clinic ON orders.clinicName = clinic.clinicName JOIN inventory ON orders.itemType = inventory.itemName WHERE MONTH(orderDate) = @orderDate";
                MySqlConnection MyConn = new MySqlConnection(Conn);
                MySqlCommand cmd = new MySqlCommand(Query, MyConn);
                cmd.Parameters.AddWithValue("@orderDate", searchInput);
                MyConn.Open();
