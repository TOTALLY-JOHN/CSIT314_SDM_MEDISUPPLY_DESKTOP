...
{
    public partial class viewOrderForm2 : Form
    {
        Timer t = new Timer();
        string user;
        string userID;

        public viewOrderForm2()
        {
            InitializeComponent();
            dataGridView1.AllowUserToAddRows = false;
        }

        private void viewOrderForm2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "SELECT orderID, orders.clinicName, clinic.clinicArea, itemType, itemQuantity, orderDate, deliveryDate, orderStatus, orderDetails FROM orders JOIN clinic ON orders.clinicName = clinic.clinicName";
